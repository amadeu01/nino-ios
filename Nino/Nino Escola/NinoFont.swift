...
class NinoFont: UIFont {
    ...
    static func fontForBabyNameMasterHeader() -> UIFont {
        return UIFont.init(name: "HelveticaRoundedLT-BoldCond", size: 20)!
    }
    
     //MARK: - ProfileCell
    
    static func fontForCellMainText() -> UIFont {
        return UIFont.init(name: "HelveticaRoundedLT-Bold", size: 18)!
    }
    
    static func fontForCellSecondText() -> UIFont {
        
        return UIFont.init(name: "HelveticaNeue", size: 13)!
    }
    ...
    static func fontForDetailHeader() -> UIFont {
        ...
        return UIFont.init(name: "HelveticaNeue-Bold", size: 17)!
    }
    
    static func fontForDetailHeaderSecondText() -> UIFont {
        
        return UIFont.init(name: "HelveticaNeue-Thin", size: 16)!
    }
    ...
    static func fontForButtons() -> UIFont {
        ...
        return UIFont.init(name: "HelveticaRoundedLT-Bold", size: 12)!
    }
